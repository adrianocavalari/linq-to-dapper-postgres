...
namespace Dapper.Contrib.Linq2Dapper.Postgre.Helpers
{
    internal class QueryHelper
    {
        ...
        {
            return ((exp is MemberExpression expression) &&
        ...
        internal static bool IsSpecificMemberExpression(Expression exp, Type declaringType, Dictionary<string, string> propertyList)
        {
            ...
            return ((exp is MemberExpression expression) &&
                    (expression.Member.DeclaringType == declaringType) &&
                    propertyList[(expression.Member.Name)] != null);
        }
        ...
        {
            return (expr is MemberExpression expression) && (expression.Member.Name == "HasValue");
        }
        ...
        {
            return (expr is MemberExpression expression) && (expression.Expression is ConstantExpression);
        }
